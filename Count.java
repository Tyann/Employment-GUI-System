 ...
 * @author Yann T
 */
public class Count extends JFrame implements TextListener, ActionListener{
    ...
    Count(){
        ...
        //top block
        Label l0 = new Label("Number Of Employees", Label.CENTER);
...
//2nd label
        Panel pm = new Panel();
        Label l1 = new Label("Click button to display the total count of Employees: ", Label.CENTER);
        ...
        Panel pm2 = new Panel();
        Label l3 = new Label("Total number of Employees is:- ", Label.CENTER);
